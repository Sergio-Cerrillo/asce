...
import { Users, FileCheck, CreditCard, UserPlus, Calendar, Shield, ArrowRight, Landmark } from "lucide-react"
...
const services = [
    {
        title: "Financiación",
        description: "Financiación a clientes, tanto para afrontar sus proyectos empresariales, como para sus necesidades particulares, en condiciones ventajosas.",
        icon: Users,
    },
    {
        title: "Negociación",
        description: "Negociación con entidades financieras, elaboración, preparación  y tramitación de toda la documentación necesaria.",
        icon: UserPlus,
    },
    {
        title: "Planificación",
        description: "Realización de Planes de Empresa.",
        icon: FileCheck,
    },
    {
        title: "Tramitación",
        description: "Tramitación de avales y garantías.",
        icon: Shield,
    },
    {
        title: "Inversión",
        description: "Oferta de productos de inversión tanto de renta fija como renta variable.",
        icon: CreditCard,
    }
]
...
const benefits = [
    {
        ...
        description: "Cubrir las necesidades de Inversión y Financiación de nuestros clientes.",
    }
]
                    ...
                    >
                        <Card className="bg-gradient-to-r from-purple-600 to-blue-700 text-white border-0">
                            <CardContent className="p-12">
                                ...
                                <h2 className="text-3xl font-bold mb-4">Gestiona tus finanzas de forma eficiente</h2>
